  ...
  box.innerHTML = `
    ...
    <div class="g-bottom">
      ...
      <div class="g-summary">
        ...
        <div class="g-summary-item"><strong>${t('graphicBestOverall')}:</strong><br>${bestOverall ? `${t('constructionWord')} ${constructionLabel(bestOverall.index)} ${esc(bestOverall.item.name)}` : '–'}</div>
