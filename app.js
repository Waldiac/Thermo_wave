...
function materialBuilderItemFromForm() {
  ...
  const category = mbVal('mbCategory') || 'User materials';
...
function clearMaterialBuilderForm() {
  ...
  ['mbNameDe','mbNameEn','mbCategory','mbSource','mbLambda','mbDensity','mbHeat','mbThickness','mbMu'].forEach(id => { const el = $(id); if (el) el.value = ''; });
...
function fillMaterialBuilderForm(item) {
  ...
  $('mbCategory').value = item.category || '';
