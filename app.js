...
const I18N = {
  de: {
    ...
    s4Title:'5. Wand in Vergleich übernehmen und nächste Wand bearbeiten', saveConstruction:'Konstruktion speichern', addUpdateComparison:'Zum Vergleich hinzufügen/aktualisieren', reportButton:'Bericht: vergleichende Bewertung', clearComparisonOnly:'Nur Vergleich löschen', comparisonHint:'Der Vergleich akzeptiert bis zu 10 Konstruktionen. Gespeicherte Konstruktionen bleiben in der Browser-Bibliothek und können oben wieder geladen werden.', construction:'Konstruktion', date:'Datum', enShift:'EN shift h', delayH:'Verzögerung h', plainAssessment:'Einfache Bewertung',
    s5Title:'6. Datenaustausch / Sicherung', exportProject:'Projekt-JSON exportieren', importProject:'Projekt-JSON importieren', exportMaterials:'Material-JSON exportieren', importMaterials:'Material-JSON importieren', localDataHint:'Alle Daten werden lokal im Browser gespeichert. Es werden keine Daten an EAACA oder einen Server übertragen.',
  ...
  en: {
    ...
    s4Title:'5. Add wall to comparison and continue with next wall', saveConstruction:'Save construction', addUpdateComparison:'Add/update in comparison', reportButton:'Report: comparative assessment', clearComparisonOnly:'Clear comparison only', comparisonHint:'The comparison accepts up to 10 constructions. Saved constructions remain in the browser library and can be loaded again at the top.', construction:'Construction', date:'Date', enShift:'EN shift h', delayH:'Delay h', plainAssessment:'Plain assessment',
    s5Title:'6. Data exchange / backup', exportProject:'Export project JSON', importProject:'Import project JSON', exportMaterials:'Export materials JSON', importMaterials:'Import materials JSON', localDataHint:'All data are stored locally in the browser. No data are transmitted to EAACA or any server.',
...
function bind() {
  ...
  on('printLayerBuildUp', 'click', printLayerBuildUpOnly);
